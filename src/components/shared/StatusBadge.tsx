...
const statusConfig: Record<LeadStatus, { label: string; bgColor: string; textColor: string; dotColor: string }> = {
  new: { label: 'New', bgColor: 'bg-surface-100', textColor: 'text-surface-800', dotColor: 'bg-surface-400' },
  identified: { label: 'Identified', bgColor: 'bg-blue-100', textColor: 'text-blue-800', dotColor: 'bg-blue-400' },
  ...
  captured: { label: 'Captured', bgColor: 'bg-cyan-100', textColor: 'text-cyan-800', dotColor: 'bg-cyan-400' },
