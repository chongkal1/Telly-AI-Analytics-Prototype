...
export function TopicsPanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-surface-50">
      {/* Tab bar */}
      <div className="bg-white border-b border-surface-200 px-6 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto">
        {activeTab === 'topics' ? (
          <div className="p-6">
            {/* Info banner */}
            <div className="bg-[#00C5DF]/10 border border-[#00C5DF]/30 rounded-lg px-4 py-3 mb-4">
              ...
              <p className="text-sm text-surface-600 mt-0.5">
                ...
                <span className="font-medium text-surface-800">X Not relevant</span> to remove it.
              </p>
            </div>
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center py-12">
              ...
              <p className="text-sm text-surface-500">No alerts yet</p>
              <p className="text-xs text-surface-400 mt-1">We&apos;ll notify you when something needs attention.</p>
            </div>
          </div>
        )}
      </div>
