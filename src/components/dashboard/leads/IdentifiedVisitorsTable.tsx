  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
      <div className="px-4 py-3 border-b border-gray-100">
        <h3 className="text-sm font-semibold text-gray-900">Identified Visitors</h3>
          ...
          <tbody className="divide-y divide-gray-200">
            {paginated.map((row) => (
              <tr key={row.id} className="hover:bg-gray-50">
                ...
                <td className="px-3 py-2 text-sm text-gray-700 max-w-[180px] truncate">{row.title}</td>
                <td className="px-3 py-2 text-sm text-gray-500 max-w-[200px] truncate font-mono text-xs">{row.sourceUrl}</td>
